...
urlpatterns = [
    ...
    # Password Reset View
    path("password_reset/", auth_views.PasswordResetView.as_view(template_name="main/password_reset.html", subject_template_name=reset_subject, email_template_name=reset_email_template), name='password_reset'),
