...
reset_email_template = "main/password_reset_email.html"
...
urlpatterns = [
    ...
    # Password Reset View
    path("password_reset/", auth_views.PasswordResetView.as_view(template_name="main/password_reset.html", subject_template_name=reset_subject, html_email_template_name=reset_email_template), name='password_reset'),
