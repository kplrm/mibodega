...
urlpatterns = [
    ...
    path("password_reset/done/", auth_views.PasswordResetDoneView.as_view(template_name="main/password_reset_done.html", subject_template_name=reset_subject), name='password_reset_done'),
