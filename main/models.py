...
class ProductosAprobados(models.Model):
    ...
    pa_image = models.ImageField(upload_to='img_productos',blank=True,verbose_name="PNG 150x150")
...
class Bodega(models.Model):
    ...
    bd_delivery = models.BooleanField(default=False,verbose_name="¿Hace delivery?")
    ...
    bd_delivery_type = models.BooleanField(default=False,verbose_name="¿A partir de qué monto el delivery es gratis?") # False = delivery has always the same price, True = free_starting_on
    bd_delivery_free_starting_on = models.DecimalField(default=0.00,max_digits=6,decimal_places=2,blank=True,null=True,verbose_name="¿A partir de qué monto de compra el delivery es gratis?")
    bd_delivery_conditions = models.CharField(default="48 horas",max_length=250,blank=True,null=True,verbose_name="Tiempo de entrega")
...
class ProductosEnBodega(models.Model):
    ...
    peb_discount_price = models.FloatField(default=0,blank=False,null=False,verbose_name="Precio con descuento")
...
#    oi_date_created = models.DateTimeField(auto_now_add=True,blank=True,null=True,verbose_name="Fecha de creación")
    ...
    # only for debugging
    oi_date_created = models.DateTimeField(default=timezone.now(),blank=True,null=True,verbose_name="Fecha de creación")
