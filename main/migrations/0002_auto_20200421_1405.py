    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bd_ruc', models.CharField(blank=True, max_length=11, null=True, verbose_name='RUC')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('lpd_ID', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='ID Lista de productos')),
                ('ldp_regular_price', models.FloatField(default=0, verbose_name='Precio regular')),
                ('ldp_discount_price', models.FloatField(blank=True, default='', verbose_name='Precio con descuento')),
                ...
                ('ldp_status', models.BooleanField(default=True, verbose_name='Disponible')),
                ('ldp_cod', models.ForeignKey(blank=True, default='', on_delete=django.db.models.deletion.CASCADE, to='main.Bodega', verbose_name='Bodega')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='ldp_product',
            field=models.ForeignKey(blank=True, default='', on_delete=django.db.models.deletion.CASCADE, to='main.ProductosAprobados', verbose_name='Producto'),
        ),
        migrations.AddField(
            model_name='bodega',
            name='bd_user',
