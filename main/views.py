...
def search_cart_items_in_bodegas(shop,cart_list):
    ...
    return total_price_inc_delivery, len(items_in_bodega), shop.bd_name, tuple(items_in_bodega)
    ...
    try:
        ...
        for result in bodegas_w_products_w_delivery:
            ...
            # If items are available only buying at two shops
                ...
                result_list.append([result[0]+second_bodega_w_products_w_delivery[0][0],result,second_bodega_w_products_w_delivery[0]])
